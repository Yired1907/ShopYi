...
@section('content')
    ...
    <script type="text/javascript">
        ...
        image.forEach(item=>{
            ...
            const imgOverlay = item.querySelector(".slick3-dot-overlay")
            const regex = /storage/;
            if(!regex.test(img.src)){
                imgOverlay.classList.remove("slick3-dot-overlay")
            ...
            wrapDivImg.src = img.src
            zoomImg.href = img.src
            })
        })

        const arrowPre = document.querySelector(".prev-slick3")
        const arrowNext = document.querySelector(".next-slick3")
        let num=0
        ...
        arrowNext.addEventListener('click',()=>{
            if(num<3){
                ...
                wrapDivImg.src =imgSlide[num].src
            }else{
                num=0
            }
