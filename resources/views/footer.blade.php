    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="http://shop.vtest" class="stext-107 cl7 hov-cl1 trans-04">
                            <img src="/template/images/icons/yi.png" width="100px" alt="IMG-LOGO">
                        </a>
                    </li>
                    </li>
                </ul>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    <h6>108 Lưu Hữu Phước-P.15-Q.8-TP.HCM</h6>
                    <h6>----------------------------------------------------------------</h6>
                    <h6>(84+) 79.4946.985</h6>
                </p>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="nhập địa chỉ gmail">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                <div class="item-slick3" data-thumb="/template/images/product-detail-03.jpg">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/template/images/product-detail-01.jpg images/product-detail-03.jpg">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
